...
TerminalDescriptor LBFFTerminalDesc[] =
{
    ...
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_DOL_LONG_INPUT",
        PAC_BUFFER_TYPE_NONE,
        TERMINAL_BUFFER_TYPE_DATA,
        TERMINAL_DIR_IN,
    ...
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_DOL_SHORT_SMTH_INPUT",
        PAC_BUFFER_TYPE_NONE,
        TERMINAL_BUFFER_TYPE_DATA,
        TERMINAL_DIR_IN,
    ...
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_DPC_PDAF_OUTPUT",
        PAC_BUFFER_TYPE_SPATIAL_OUT,
        TERMINAL_BUFFER_TYPE_METADATA,
        TERMINAL_DIR_OUT,
    ...
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_BNLM_SM_INPUT",
        PAC_BUFFER_TYPE_SPATIAL_IN,
        TERMINAL_BUFFER_TYPE_METADATA,
        TERMINAL_DIR_IN,
    ...
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_BLEND_SM_INPUT",
        PAC_BUFFER_TYPE_SPATIAL_IN,
        TERMINAL_BUFFER_TYPE_METADATA,
        TERMINAL_DIR_IN,
    ...
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_BGB_YUV_INPUT",
        PAC_BUFFER_TYPE_NONE,
        TERMINAL_BUFFER_TYPE_DATA,
        TERMINAL_DIR_IN,
        0, // No graphs found
...
{
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_CV_DATA_INPUT",
        PAC_BUFFER_TYPE_NONE,
        TERMINAL_BUFFER_TYPE_DATA,
        TERMINAL_DIR_IN,
        0, // sw_segnet
    },
    {
        ...
        TERMINAL_TYPE_CONNECT,
        "TERMINAL_CONNECT_CV_DATA_OUTPUT",
        PAC_BUFFER_TYPE_SPATIAL_OUT,
        TERMINAL_BUFFER_TYPE_METADATA,
        TERMINAL_DIR_OUT,
        0, // sw_segnet
...
TerminalDescriptor SW_AINRTerminalDesc[] =
{
    {
...
int CountOfSW_AINRTerminalDesc = sizeof(SW_AINRTerminalDesc) / sizeof(SW_AINRTerminalDesc[0]);
